...
**LbPrivateSubnetNoList** | **[]\*int32** | 로드밸런서 전용 Private Subnet No 목록(존별 1개) | [default to null]
**LbPublicSubnetNo** | ***int32** | 로드밸런서 전용 Public Subnet No | [optional] [default to null]
**LbPublicSubnetNoList** | **[]\*int32** | 로드밸런서 전용 Public Subnet No 목록(존별 1개) | [optional] [default to null]
...
**AuthType** | ***string** | 클러스터 인증 타입 | [default to null]
**IsRegional** | ***bool** | 멀티존 클러스터 여부 | [optional] [default to null]
